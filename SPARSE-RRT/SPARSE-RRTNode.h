...
Eigen::Matrix<double, CONTROL_SPACE_DIM,1> RandomControl(Eigen::Matrix<double, CONTROL_SPACE_DIM,1>, Eigen::Matrix<double, CONTROL_SPACE_DIM,1> controlGoal, std::array<int,CONTROL_SPACE_DIM> controlCare);
